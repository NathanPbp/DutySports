...
public function duplicar($id)
{
    ...
    $produtoDuplicado = $this->produtos_model->duplicarProduto($id);

    if ($produtoDuplicado) {
        $this->session->set_flashdata('success', 'Produto duplicado com sucesso!');
    } else {
        $this->session->set_flashdata('error', 'Erro ao duplicar produto.');
    }
