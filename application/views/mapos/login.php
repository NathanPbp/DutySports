...
<head>
  <title>Duty Sports - Login</title>  <meta charset="UTF-8" />
...
<body>
  <div class="main-login">
    <div class="left-login">
      ...
      <h2 class="h-two"> Ao Sistema de Controle e Ordens de Serviço da Duty Sports</h2>
      <img src="<?= base_url('assets/img/dashboard1.png') ?>" class="left-login-image">
            ...
            <div class="card">
              <div class="content">
                ...
                <!--div class="links-uteis"><a href="https://github.com/RamonSilva20/mapos"-->
                    <p>
  <?= date('Y'); ?> &copy;
  <span id="np-easter" style="cursor:pointer;">NP</span>
</p>
                  </a>
                </div>
...
<div id="cat-easter-egg" style="
    ...
    align-items:center;
">
    <img src="<?= base_url('assets/img/gato.png') ?>"
         style="
            max-width:90vw;
            max-height:90vh;
            object-fit:contain;
...
document.getElementById('np-easter').addEventListener('click', function () {
    npClicks++;

    if (npClicks === 10) {
        document.getElementById('cat-easter-egg').style.display = 'flex';
        npClicks = 0;
    }
});

document.getElementById('cat-easter-egg').addEventListener('click', function () {
